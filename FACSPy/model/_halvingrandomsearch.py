...
class HalvingRandomSearchCV_TE(BaseSuccessiveHalving_TE):
    ...
    This class is a copy of sklearns HalvingRandomSearchCV.
    However, there is a custom addition of the code in order
    to allow multidimensional inputs. Once this error is fixed
    in the sklearn library, this class will be replaced
