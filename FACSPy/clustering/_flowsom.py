### copied from github.com/Hatchin/FlowSOM
...
class ConsensusCluster:
    """
      ...
      Args:
      copied from https://github.com/Hatchin/FlowSOM/blob/master/script/cluster.py
...
def flowsom(dataset: ad.AnnData,
            metaclustering_algorithm,
            x: int,
            y: int,
            sigma: float,
            learning_rate: float,
